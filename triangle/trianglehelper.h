...
namespace TriHelper {
    ...
    {
    public:
        TriangleHelper(std::vector<double*> boundary, std::vector<std::vector<double*> > holes, std::vector<double*> constraints_vertices, std::vector<std::pair<unsigned int, unsigned int> > segments);
